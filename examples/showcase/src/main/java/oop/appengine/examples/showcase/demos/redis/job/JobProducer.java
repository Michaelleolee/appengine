package oop.appengine.examples.showcase.demos.redis.job;

import java.util.concurrent.atomic.AtomicLong;

import oop.appengine.modules.test.benchmark.BenchmarkTask;
import oop.appengine.modules.test.benchmark.ConcurrentBenchmark;
