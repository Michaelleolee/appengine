package oop.appengine.examples.showcase.webservice.soap;
...
import oop.appengine.examples.showcase.service.AccountEffectiveService;
import oop.appengine.examples.showcase.webservice.soap.response.GetTeamDetailResult;
import oop.appengine.examples.showcase.webservice.soap.response.GetUserResult;
import oop.appengine.examples.showcase.webservice.soap.response.SearchUserResult;
import oop.appengine.examples.showcase.webservice.soap.response.base.IdResult;
...
import oop.appengine.modules.beanvalidator.BeanValidators;
import oop.appengine.modules.mapper.BeanMapper;
import oop.appengine.modules.utils.Exceptions;
...
@WebService(serviceName = "AccountService", endpointInterface = "oop.appengine.examples.showcase.webservice.soap.AccountSoapService", targetNamespace = WsConstants.NS)
